...
export const executiveCommittee: Member[] = [
	{
		...
		department: 'EECE',
		major: 'Power',
		avatar: withBase('images/home/avatar-munawar.png'),
	},
	{
		...
		department: 'EECE',
		major: 'Electronics',
		avatar: withBase('images/home/avatar-nasiruddin.png'),
	},
	{
		...
		department: 'EECE',
		major: 'Communication',
		avatar: withBase('images/home/avatar-mehedi.png'),
	},
	{
		name: 'Hafsa Khan',
		role: 'Treasurer',
		department: 'EECE',
		major: 'Electronics',
		avatar: withBase('images/home/avatar-hafsa.png'),
	},
	{
		...
		department: 'EECE',
		major: 'Communication',
		avatar: withBase('images/home/avatar-mahdia.png'),
	},
	{
		name: 'Nushaira Monsur Raya',
		role: 'Visual Co-Ordinator',
		department: 'PME',
		avatar: withBase('images/home/avatar-nushaira.png'),
	},
];
...
export const associateDirectors: AssociateGroup[] = [
	{
		...
		members: [
			{ name: 'Tahiya Iffat Majumder', role: 'Operation and Logistics' },
			{ name: 'Nusaiba Ahmed Naisha', role: 'Visual & Graphics' },
			{ name: 'Mohtasin Fuad Mahin', role: 'R&D' },
			{ name: 'Md. Abidur Rahman', role: 'Webmaster' },
			{ name: 'Yeasin Nobi Muhi', role: 'Membership Driven Program' },
			{ name: 'Tasmima Yasmin Puspita', role: 'Public Relations & Branding' },
			{
				name: 'Fathin Hasnath Amil',
				role: 'Content Writer and Publication',
				avatar: withBase('images/home/avatar-fathin.png'),
			},
		],
	},
	{
